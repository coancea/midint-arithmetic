...
def divTest [n][m][q] (uss: [n][m][2*q]u64) (vss: [n][m][2*q]u64) : bool =
   ...
   let tmp = imap2Intra (vss :> [n][1*m][2*q]u64) (quo :> [n][1*m][2*q]u64) bmul
   let uss'= imap2Intra tmp (rem  :> [n][1*m][2*q]u64) badd
...
-- output { true }
--entry bdiv1024Q4 [m] (uss0: [m][256][4]u64) (vss0: [m][256][4]u64) =
--  #[unsafe]
