...
-- ==
-- entry: oneAddition2048Q8
-- compiled random input { [32768][256][8]u64  [32768][256][8]u64 } auto output
entry oneAddition2048Q8 [m] (ass0: [m][256][8]u64) (bss0: [m][256][8]u64) : [m][1*256][8]u64 = #[unsafe]
...
entry oneAddition2048 [m] (ass0: [m][512][4]u64) (bss0: [m][512][4]u64) : [m][1*512][4]u64 = #[unsafe]
...
-- ==
-- entry: sixAdditions2048Q8
-- compiled random input { [32768][256][8]u64  [32768][256][8]u64 } auto output
entry sixAdditions2048Q8 [m] (ass0: [m][256][8]u64) (bss0: [m][256][8]u64) : [m][1*256][8]u64 = 
   #[unsafe]
   let ass = ass0 :> [m][(1*256)][8]u64
   let bss = bss0 :> [m][(1*256)][8]u64
...
-- ==
-- entry: sixAdditions2048
-- compiled random input { [32768][512][4]u64  [32768][512][4]u64 } auto output
entry sixAdditions2048 [m] (ass0: [m][512][4]u64) (bss0: [m][512][4]u64) : [m][1*512][4]u64 = #[unsafe]
   let ass = ass0 :> [m][1*512][4]u64
   let bss = bss0 :> [m][1*512][4]u64
   let apb   = imap2Intra ass bss badd     -- a + b
   let a2pb2 = imap2Intra apb apb badd     -- 2 * (a + b) = 2a + 2b
